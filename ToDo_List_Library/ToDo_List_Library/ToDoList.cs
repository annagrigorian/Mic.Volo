...
namespace ToDo_List_Library
{
    public class ToDoList : IEnumerable<ToDoItem>
    {
        ...
        public IEnumerable<ToDoItem> ShowAll(ToDoList todos)
        {
            return todos.Select(t => t);
        }

        public IEnumerable<ToDoItem> ShowCompleted(ToDoList todos)
        {
            return todos.Where(t => t.IsCompleted == true);
        }

        public IEnumerable<ToDoItem> ShowNotCompleted(ToDoList todos)
        {
            return todos.Where(t => t.IsCompleted == false);
        }
